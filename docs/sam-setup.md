# Hobbs Media Co. site: what Sam needs to set up

Four things, about 20 minutes total. Do them in order. Everything is free
except the domain name.

## 1. GitHub account (where the site's code lives)

1. Go to https://github.com/signup and create an account. Use the email you
   want tied to the business.
2. Send Jonny your GitHub username. He will add you to the site's code
   repository so your hosting account can see it.

## 2. Vercel account (the hosting)

1. Go to https://vercel.com/signup.
2. Choose **Continue with GitHub** and sign in with the account from step 1.
   This links the two, which is what lets the site update automatically.
3. Pick the free **Hobby** plan.
4. Send Jonny the email you used. He will transfer the site to you; you will
   get an email asking you to accept it. Accept it.
...
Jonny connects your Vercel account to the code, points your domain at it,
and flips the site from review mode to live. From then on, any update he
makes goes live automatically within a couple of minutes. You own the
account, the domain, and the site.
